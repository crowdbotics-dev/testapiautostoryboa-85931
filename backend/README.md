...
## Project Structure
    ...
    ├── testapiautostoryboa_85931  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_85931`
...
2. Clone this repo and `cd testapiautostoryboa_85931`
